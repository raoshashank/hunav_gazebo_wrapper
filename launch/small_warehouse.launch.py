...
def generate_launch_description():
    ...
    robot_conf_file = PathJoinSubstitution(
        [FindPackageShare('hunav_gazebo_wrapper'),
         'config',
         'robot.yaml']
    )

    #Declare child launch scripts
    ...
    declare_robotgesture_topic = DeclareLaunchArgument(
        'robotgesture_topic', default_value='robot_gesture',
        description='Name of the topic in which the robot gestures are published'
    )
    ...
    ld.add_action(declare_robotgesture_topic)
